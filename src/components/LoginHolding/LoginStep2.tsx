...
const LoginStep2 = () => {
  return (
    <Fragment>
      <div className="relative left-[12px] top-[-65px]">
      ...
      <div
        className="w-[377px] h-[400px] mb-[3px] flex justify-center justify-items-center items-center pt-[33px] pb-[41px] pl-[55px] pr-[56px]">
        <div className="grid justify-items-center">
          <div className="grid justify-items-center mb-[42px] gap-[4px]">
            ...
            <p className="font-primaryMedium text-[13px] text-right text-[#252525] font-[400]">
              کد تایید به شماره <span className="text-[#008A86]">۹۸۹۱۲۱۲۳۴۵۶۷+</span> ارسال شده است ، در صورت مغایرت روی{' '}
              <span className="text-[#01CEC9]">ویرایش</span> کلیک کنید
            </p>
          </div>
          <Formik initialValues={{ otp: '' }}
           ...
           >
            {({ setFieldValue }) => (
              <Form>
                <div className="w-[262px] h-[58px] bg-transparent shadow-[0px_1px_2px_0px_#00000040_inset] rounded-[9px] text-right outline-none border-none placeholder:mr-[19px] placeholder:text-right pt-[14px] font-primaryMedium pb-[15px] flex justify-center gap-[3px]">
                  <Field name="otp">
                    {({ field }: FieldProps) => (
                      <OtpInput
                        value={field.value}
                        ...
                        renderInput={(props) => (
                          <input
                            {...props}
                            className="bg-transparent mr-3 text-center text-2xl outline-none text-[#005351] border-[#f7f7f7] border border-b-[#E6E6E6]"
                            // style={{
                            //   width: '30px',
                            //   display: 'flex',
                ...
                <div className="grid justify-items-center mt-[31px]">
                  <button
                    className="font-primaryMedium text-[13px] bg-[#E48900] w-[133px] h-[43.1px] rounded-[21px] text-[#FFFFFF]"
                    type="submit"
                  >
                    ورود به حساب
                  </button>
