...
import { PostNewsComment , PostReplyNewsComment} from '../../../core/services/api/News';
...
const Comment = ({comment , uuid , item}) => {
  ...
  return (
    ...
    <div className='w-[768px]   mr-[20px] grid gap-[10px]
         px-[23px] bg-[#F9F9F9] rounded-[7px] mt-[19px]
         '>
     
       <div className='w-[721px] h-[117px]   mt-[19px]'>
              <div className='h-[70px] w-[721px] flex 
       justify-between
       '> 
           <div className='w-[202px] h-[62px]  flex gap-[8px]'>
          <img src={item.pictureAddress} className="rounded-full w-[50px] h-[50px]" />
               <div>
                   <p className='text-[#003B39] font-primaryRegular'>{item.autor}</p>
                   <p className='text-[14px]'>{toPersianDate(item.insertDate)}</p> 
           ...
           <div className='w-[141px] h-[33px]  flex gap-[9.03px] justify-center'>
              ...
              <p className='text-[16px] '>{item.likeCount}</p>
               ...
               <div className='flex items-center gap-[7.54px]'>
               <p className='text-[16px] '>{item.dissLikeCount}</p>
               ...
               <div className='flex items-center gap-[7.54px]' onClick={() =>setIsOpen(true)}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 15 14" fill="none">
            ...
            <div className='h-[40px] w-[721px] text-[13px]'>
          <p>{item.title}</p>
           <p>{item.describe}</p> 
